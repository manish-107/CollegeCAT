  ...
  return (
    <div className="p-6 max-w-6xl mx-auto space-y-8">
      <div className="text-center">
        ...
        <p className="text-muted-foreground">View your finalized timetable for the selected year and batch</p>
      </div>

      {/* Subjects and Faculty Details */}
      <Card>
        <CardHeader>
          <CardTitle className="text-lg">Subjects Details</CardTitle>
        </CardHeader>
        <CardContent>
          {isLoading ? (
